...
\path{AWD_results_dashboard.ipynb}, version v42.  The hierarchical
...
\takeaway{v42 promotes the day-by-day seasonal correlation sections and explicitly withdraws the first anti-alias comparison pending the corrected reruns. The defensible claim remains a repeatable, conditional negative signed F--K observable near 3.075~km~s$^{-1}$, not an independent formation-velocity estimate.}
